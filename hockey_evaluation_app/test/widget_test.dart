...
void main() {
  group('All Tests', () {
    ...
    group('AuthFunc Integration Tests', () {
      testWidgets('Test navigation and UI elements', (WidgetTester tester) async {
        main();
        await tester.pumpAndSettle();

        expect(find.text('Sign In'), findsOneWidget);
        expect(find.text('Evaluations'), findsNothing);
        expect(find.text('Goaltenders'), findsNothing);
        ...
        expect(find.text('Goaltenders'), findsOneWidget);

        // Got to evaluations
        await tester.tap(find.text('Evaluations'));
        await tester.pumpAndSettle();
        expect(find.byType(EvaluationListView), findsOneWidget);

        // try to navigate back
        await tester.tap(find.byType(BackButton));
        await tester.pumpAndSettle();

        // Test navigation to Goaltenders
        await tester.tap(find.text('Goaltenders'));
        await tester.pumpAndSettle();
        expect(find.byType(GoaltenderListView), findsOneWidget);

        // try to navigate back
        await tester.tap(find.byType(BackButton));
        await tester.pumpAndSettle();

        // Test navigation to Organization
        ...
        await tester.pumpAndSettle();
        expect(find.byType(TheseSettings), findsOneWidget);
